defmodule PentoWeb.Admin.SurveyResultsLive do
  ...
  def assign_age_group_filter(socket, age_group \\"all") do
    socket
  ...
  def assign_dataset(
    %{assigns: %{
      ...
      |> assign(
        :dataset,
        make_bar_chat_dataset(products_with_average_ratings)
      )
    end

    defp make_bar_chat_dataset(data) do
